let data = [
  { value: '高潮狂喷！', time: 5, color: 'red', speed: 1, fontSize: 22 },
  { value: '快乐肥仔', time: 10, color: '#00a1f5', speed: 1, fontSize: 30 },
  { value: '美国是中国的', time: 6 },
  { value: 'pua在上新高度', time: 14, color: '#00a1f5', speed: 2, fontSize: 26 },
  { value: '段鑫最帅', time: 15 },
  { value: '大屌好大', time: 20, color: '#fff', speed: 4, fontSize: 20 },
]
